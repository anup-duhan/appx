        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-6 py-[18px] overflow-hidden'>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2'>
                <div data-aos="fade-right">
                    ...
                    <h2 className='leading-none text-[43px] lg:text-7xl bg-[#fcbf4e;] inline-block lg:py-2 lg:my-4  my-[20px] font-bold font-style'> Starts here</h2>
                    <p className='text-xl font-style'>Think the credit system is stacked against you? So do we. We'll help you get the credit you deserve.</p>
