export const TopArrow = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><path fill="black" d="m12 4.836l-6.207 6.207l1.414 1.414L12 7.664l4.793 4.793l1.414-1.414zm0 5.65l-6.207 6.207l1.414 1.414L12 13.314l4.793 4.793l1.414-1.414z" /></svg>
);
...
export const Tick = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512">
        <path fill="black" d="M437.3 30L202.7 339.3L64 200.7l-64 64L213.3 478L512 94z" />
    </svg>
);
...
export const CloseButton = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <rect width="27" height="27" fill="white" mask="url(#lineMdCloseCircleFilled0)" />
    </svg>
)